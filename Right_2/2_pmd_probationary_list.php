...
<body class="">   
	...
	<div class="content"> 
        <div class="header">
          ...
          <ul class="breadcrumb">
            <li><a href="2_index.php">返回首页</a> / <span class="divider">预备党员列表</span></li>                       
         </ul>
    ...
    <table class="table" >
      ...
      <tbody>
        <tr>
          ...
          <td>张三</td>
          <td>本科生</td>
          <td><a href="2_pmd_probationary_confirmationLetter.php">函调证明材料表</a></td>
          <td><a href="2_pmd_probationary_stu.php">详细信息</a></td>
          <td>
        ...
        <tr>
          ...
          <td>教师</td>
          <td><a href="2_pmd_probationary_confirmationLetter.php">函调证明材料表</a></td>
          <td><a href="2_pmd_probationary_tea.php">详细信息</a></td>
          <td>
            <a href="#delete" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
        </tr>
