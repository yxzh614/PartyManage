...
<body class="">   
	...
	<div class="content"> 
        ...
        <ul class="breadcrumb">
            <li><a href="3_index.php">返回首页</a> /<span class="divider">申请入党人员信息</span></li>
        </ul>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>张三</td>
          <td>本科生</td>
          <td><a href="3_pmd_applicant_stu.php">详细信息</a></td>
          <td>
         ...
         <tr>
          ...
          <td>李四</td>
          <td>教师</td>
          <td><a href="3_pmd_applicant_tea.php">详细信息</a></td>
          <td>
              <a href="#delete" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
        </tr>
