...
WHERE ID_number='".$_GET["ID"]."'";
 if($resGTR1=mysqli_query($db,$sqlGetTeaR1)){
          ...
          <tr align="center">
            ...
            <td>专业</td>
           <td><?php echo $rowsGTR1["major"]; ?></td>
            <td>排名</td>
            <td colspan="2"><?php echo $rowsGTR1["ranking"]; ?></td>
          </tr>
          <tr align="center">
            <td>列积极分子时间</td>
          ...
          <tr align="center">
            <td>寝室楼号</td>
            <td><?php echo $rowsGTR1["floor_number"]; ?></td>
            <td colspan="2">寝室号</td>
            <td><?php echo $rowsGTR1["dormitory_number"]; ?></td>
            <td>床号</td>
            <td><?php echo $rowsGTR1["bed_number"]; ?></td>
          </tr>
          <tr align="center">
            <td>辅导员</td>
            <td><?php echo $rowsGTR1["instructor_ID"]; ?></td>
            <td colspan="2">状态</td>
            <td><?php echo $rowsGTR1["state"]; ?></td>
            <td>挂科数</td>
            <td><?php echo $rowsGTR1["all_funkobject_amount"]; ?></td>
          </tr>
          <tr align="center">
            <td>突出表现和存在不足</td>
...
<div class="modal small hide fade" id="change_1" tabindex="10" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <form id="tab">
       ...
       <input type="text" name="tel" value="<?php echo $rowsGTR1["tel"]; ?>" class="input-xlarge">
        ...
        <label>身份证号</label>
        <input type="text" name="ID_number" value="<?php echo $rowsGTR1["ID_number"]; ?>" class="input-xlarge">
        <label>所属组织</label>
       ...
       <input type="date" name="Join_T_time" value="<?php echo $rowsGTR1["join_T_time"]; ?>">
        <label>专业</label>
        <input type="text" name="major" value="<?php echo $rowsGTR1["major"]; ?>" class="input-xlarge">
        <label>排名</label>
        <input type="number" name="ranking" min="0" value="<?php echo $rowsGTR1["ranking"]; ?>">
        <label>列积极分子时间</label>
       ...
       <input type="text" name="edu" value="<?php echo $rowsGTR1["edu_name"]; ?>"/>
        ...
        <label>高中入学日期</label>
        <input type="date" name="GZRX_date" value="<?php echo $rowsGTR1["GZRX_date"]; ?>"/>
        <label>高中毕业日期</label>
        <input type="date" name="GZBY_date" value="<?php echo $rowsGTR1["GZBY_date"]; ?>"/>
        <label>户口所在派出所</label>
        ...
        <label>寝室楼号</label>
        <input type="text" name="floor_number"  value="<?php echo $rowsGTR1["floor_number"]; ?>" class="input-xlarge">
        <label>寝室号</label>
        <input type="text" name="dormitory_number"  value="<?php echo $rowsGTR1["dormitory_number"]; ?>" class="input-xlarge">
        <label>床号</label>
        <input type="text" name="bed_number" value="<?php echo $rowsGTR1["bed_number"]; ?>" class="input-xlarge">
        <label>辅导员ID</label>
        <input type="text" name="instructor_ID" value="<?php echo $rowsGTR1["instructor_ID"]; ?>" class="input-xlarge">
        <label>状态</label>
        <select name="state">
        ...
        <label>挂科数</label>
        <input type="text" name="All_funkobject_amount" value="<?php echo $rowsGTR1["all_funkobject_amount"]; ?>" class="input-xlarge"> 
