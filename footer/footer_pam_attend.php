...
<div class="well">
  <?php echo "<form action='1_pam_meeting_information.php?id=$id' method='post'> "; ?>
    <table class="table">
      <thead>
        <tr>
          <th width="100">&nbsp;</th>
      ...
      <tbody>
<?php 
if($result=mysqli_query($db,"SELECT * FROM attend where conference_ID='".$id."'"))
	while($row=mysqli_fetch_assoc($result))
	{
