    ...
    <div align="center">
      <table width="907">
        <tbody>
          <tr align="right">
            <td width="112">姓名：</td>
            <td width="193" align="left"><input type="text" name="name" value="" class="input-medium" /></td>
            <td width="129">性别：</td>
        ...
        <input type="radio" name="sex" value="女" id="sex_1" />女</label></td>
          ...
          <tr align="right">
            <td>出生年月：</td>
            <td align="left"><input type="month"  name="datetime" class="input-medium"/></td>
            <td>民族：</td>
          ...
          <tr align="right">
            <td>身份证号：</td>
            <td align="left"><input type="text" name="ID_number" value="" class="input-medium" /></td>
            <td>籍贯：</td>
          ...
          <tr align="right">
            <td>辅导员：</td>
            <td align="left"><input type="text" name="instruct_ID" value="" class="input-medium" /></td>
            <td align="left">&nbsp;</td>
          ...
          <tr align="right">
            <td >特长：</td>
           <td align="left"><input type="text" name="strong_point" value="" class="input-medium" /></td>
           <td>户口所在派出所：</td>
          ...
          <tr align="right">
            <td>家庭住址：</td>
            <td align="left"><input type="text" name="address" value="" class="input-medium" /></td>
            <td>邮政编码：</td>
            <td align="left"><input type="text" name="zip_code" value="" class="input-medium" /></td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr align="right">
            <td>联系电话：</td>
            <td align="left"><input type="text" name="tel" value="" class="input-medium" /></td>
            <td>楼号：</td>
            <td align="left"><input type="text" name="floor_number" value="" class="input-medium" /></td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr align="right">
            <td>班级学号：</td>
            <td align="left"><input type="text" name="stu_number" value="" class="input-medium" /></td>
            <td>寝室号：</td>
            <td align="left"><input type="text" name="dormitory_number" value="" class="input-medium" /></td>
            <td align="left">&nbsp;</td>
          </tr>
          <tr align="right">
            <td>专业：</td>
            <td align="left"><input type="text" name="major" value="" class="input-medium" /></td>
            <td>床号：</td>
            <td align="left"><input type="text" name="bed_numbe" value="" class="input-medium" /></td>
            <td align="left">&nbsp;</td>
          </tr>
          </tbody>
      </table>
