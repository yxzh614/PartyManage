...
<div class="well">
    <div align="center">
      ...
      <table width="694" >
        <tbody>
        <?php
        $sqlGetStuR1="SELECT Tmember_meet_time,JJPX_time,JJPX_mark FROM personnelinformation WHERE personnelinformation.ID_number='".$_GET["ID"]."'";
        if($resGSR1=mysqli_query($db,$sqlGetStuR1)){
            while ($rowsGSR1=mysqli_fetch_assoc($resGSR1)){
                ...
                <tr align="right">
                    ...
                    <td width="103" align="left"><input type="date" name="Tmember_meet_time" class="input-medium" value="<?php echo $rowsGSR1['Tmember_meet_time'];?>"></td>
                </tr>
                <tr align="right">
                    <td>入党积极分子分子培训时间：</td>
