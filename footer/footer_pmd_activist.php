        ...
        if(isset($_POST["submit"])&&$_POST["submit"]) {
            ...
            <form action="../footer/footer_pmd_activist.php?ID=<?php echo $_GET["ID"];?>" method="post" id="edit">
                ...
                <div class="btn-toolbar">
                    <button class="btn btn-primary" type="button" onclick="sendPost()">保存</button>
                </div>
                <div class="well">
                    <div align="center">
                        <table width="694" >
                            ...
                            if($resGSR1=mysqli_query($db,$sqlGetStuR1)){
                                while ($rowsGSR1=mysqli_fetch_assoc($resGSR1)){
                                    ...
                                    <tr align="right">
                                        ...
                                        <td width="203" align="left"><select name="ZQ_positivemeet_ID" id="ZQ_positivemeet_ID" class="input-medium">
                                                <?php
                                        ...
                                        <td width="103" align="left">
                                            <input type="date" id="Tmember_meet_time" name="Tmember_meet_time" class="input-medium" value="<?php echo $rowsGSR1['Tmember_meet_time'];?>">
                                        </td>
                                    </tr>
                                    <tr align="right">
                                        <td>入党积极分子分子培训时间：</td>
                                        <td align="left"><input type="date" id="JJPX_time" name="JJPX_time" class="input-medium" value="<?php echo $rowsGSR1['JJPX_time'];?>"></td>
                                        <td>培训成绩：</td>
                                        <td align="left"><input type="number" id="JJPX_mark" max=100 name="JJPX_mark" class="input-medium" value="<?php echo $rowsGSR1['JJPX_mark'];?>"></td>
                                    </tr>
                                    <?php
                                }
                            }
            ...
            <script>
                function sendPost() {
                    $.post(
                        "../footer/ajax_footer_pmd_activist.php",
                        {
