...
<div class="well">
  ...
  <tbody >
    <tr>
      ...
      <td width="152"><div align="right">申请入党时间：</div></td>
      <td width="185"><input type="date" name="SQRD_time" value="<?php echo $rowsGTR1["SQRD_time"]; ?>" class="input-medium" /></td>
    ...
    <tr>
      ...
      <td rowspan="2"><div align="right">获奖情况：</div>        <div align="right"></div></td>
    ...
    <tr>
      ...
      <td rowspan="2"><div align="right">突出表现和存在不足：</div>        <div align="right"></div></td>
    ...
    <tr>
      ...
      <td rowspan="2"><div align="right">备注：</div>        <div align="right"></div></td>
      <td rowspan="2"><input type="text" name="remark" value="<?php echo $rowsGTR1["remark"]; ?>" class="input-medium" /></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
