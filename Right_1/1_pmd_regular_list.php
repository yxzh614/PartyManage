    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>张三</td>
          <td>本科生</td>
          <td><a href="1_pmd_regular_probationary.php">预备党员转正公示表</a></td>
          <td><a href="1_pmd_regular_stu.php">详细信息</a></td>
          <td>
        ...
        <tr>
          ...
          <td>教师</td>
          <td><a href="1_pmd_regular_probationary.php">预备党员转正公示表</a></td>
          <td><a href="1_pmd_regular_tea.php">详细信息</a></td>
          <td>
            <a href="#delete" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
        </tr>
...
<div class="btn-toolbar">
    ...
    <button class="btn">党委审批预备党员转正会议</button>
    <button class="btn">预备党员转正公示时间</button>
    <button class="btn">转正时间</button>
    <button class="btn">入党时间</button> 
</div>
</div>
</div>
