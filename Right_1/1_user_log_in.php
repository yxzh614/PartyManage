...
<body class="">
<?php include("1_footer_body_statistics.php"); ?>
...
<div class="content">
    ...
    <ul class="breadcrumb">
        <li><a href="1_index.php">返回首页</a> / <span class="divider">用户登录信息表</span></li>
    </ul>
        ...
        <div class="row-fluid">
            ...
            <div class="well">
                <table class="table">
                    ...
                    if($resSU=mysqli_query($db,$sql_user)){
                        while($rowSU = mysqli_fetch_assoc($resSU)){
                            ?>
                            <tr>
                                <td><?php echo $rowSU["ID_number"]?></td>
                                <td><?php echo $rowSU["username"]?></td>
                                <td><?php echo $rowSU["password"]?></td>
                                <td><?php switch ($rowSU["type"]){
                                        case 0:echo "管理员";break;
                                        case 1:echo "教师"; break;
                                        case 2:echo "学生";break;}
                                    ?></td>
                                <td><?php echo $rowSU["rights"]?></td>
                                <td>
