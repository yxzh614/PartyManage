    ...
    <table class="table" >
      ...
      <tbody>
        <tr>
          ...
          <td>张三</td>
          <td>本科生</td>
          <td><a href="../Right_1/1_pmd_probationary_confirmationLetter.php">函调证明材料表</a></td>
          <td><a href="../Right_1/1_pmd_probationary_stu.php">详细信息</a></td>
          <td>
        ...
        <tr>
          ...
          <td>教师</td>
          <td><a href="../Right_1/1_pmd_probationary_confirmationLetter.php">函调证明材料表</a></td>
          <td><a href="../Right_1/1_pmd_probationary_tea.php">详细信息</a></td>
          <td>
            <a href="#delete" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
        </tr>
...
<div class="btn-toolbar">
    ...
    <button class="btn">支部确定发展对象会议</button>
    <button class="btn">计划发展时间</button> 
    <button class="btn">支部接收预备党员会议</button> 
    <button class="btn">接收预备党员公示时间</button> 
    </br></br>
    <button class="btn">谈话人</button>
    <button class="btn">谈话地点</button> 
    <button class="btn">谈话时间</button> 
    <button class="btn">党委审批预备党员会议</button>
    <button class="btn">党前培训时间</button>
    <button class="btn">列发展对象时间</button> 
